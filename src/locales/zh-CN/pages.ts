export default {
  'pages.layouts.userLayout.title': '小牛数字资产量化交易系统',

  'pages.welcome': '欢迎使用小牛',
  'pages.welcome.title': '小牛数字资产量化交易系统',
  'pages.welcome.title5': '小牛是款数字资产量化交易系统，包括BTC量化、ETH量化、BCH量化等主流币种量化交易',
  ...
  /** future.ext.order*/
  'pages.future.side.order.title': '订单交易列表',
  'pages.future.side.order.long.title': 'Long交易列表',
  'pages.future.side.order.short.title': 'Short交易列表',
  'pages.future.side.order.side': '方向',
  'pages.future.side.order.positionSide': 'Long/Short',
  'pages.future.side.order.orderId': 'OrderId',
  'pages.future.side.order.clientOrderId': 'ClientOrderId',
  'pages.future.side.order.price': '价格',
  'pages.future.side.order.rUnitQty': 'U数量',
  'pages.future.side.order.lUnitQty': '币数量',
  'pages.future.side.order.fee': '交易费',
  'pages.future.side.order.feeAsset': '交易币种',
  'pages.future.side.order.realizedProfit': '利润',
  'pages.future.side.order.runEnvironment': '环境',
  'pages.future.side.order.state': '状态',
  'pages.future.side.order.username': '所属用户',
  'pages.future.side.order.symbol': '交易对',
  'pages.future.side.order.moneyTotal': '金额(U)',
  'pages.future.side.order.tokenTotal': 'Token数量',
  'pages.future.side.order.profit': '盈亏',
  'pages.future.side.order.orderType': '监测模组',
  'pages.future.side.order.entrustPrice': '委托价',
  'pages.future.side.order.stopLossPrice': '止损价',
  'pages.future.side.order.takeProfitPrice': '止盈价',
  'pages.future.side.order.interval': '时间级别',
